...
namespace WebAgroCoreBCC2021.Controllers
{
    public class InsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,tipoinsumo,descricao,quantidade,valor")] Insumo insumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,tipoinsumo,descricao,quantidade,valor")] Insumo insumo)
        {
            if (id != insumo.id)
            {
                return NotFound();
